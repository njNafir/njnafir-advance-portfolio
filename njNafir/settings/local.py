...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'njNafir_staticfiles_dirs'),
)

STATIC_ROOT = os.path.join(BASE_DIR, 'njNafir_staticfiles_cdn')

MEDIA_ROOT = os.path.join(BASE_DIR, 'njNafir_staticfiles_dirs', 'media_file')

PROT_ROOT = os.path.join(BASE_DIR, 'njNafir_staticfiles_dirs', 'med_prot_file')


MAIN_ROOT = os.path.join(BASE_DIR, 'njNafir_staticfiles_dirs')
